...
class Leadership(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        categories_mapping = {
            "nigeria-news/world-news": "news", "nigeria-news/education-news/asuu-news": "news",
            "politics": "politics", "nigeria-news/business-news": "business", "sports-news": "sports",
            "nigeria-news/entertainment-news": "entertainment", "nigeria-news/education-news": "education",
            "nigeria-news/health-news": "health"}
        lists_urls = [
            "https://leadership.ng/{}".format(item) for item in categories_mapping.keys()]
    ...
    def scrape_page_items(self, response):
        ...
        article_blocks = response.css(".jeg_post")
